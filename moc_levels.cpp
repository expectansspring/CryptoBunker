...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Levels_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Levels_t qt_meta_stringdata_Levels = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Levels[] = {
...
Q_CONSTINIT const QMetaObject Levels::staticMetaObject = { {
    ...
    qt_meta_stringdata_Levels.offsetsAndSizes,
    qt_meta_data_Levels,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Levels_t,
        // Q_OBJECT / Q_GADGET
